...
단순 분석을 넘어 **디자인 도메인 1,043개 논문 청크**에 기반한 근거 중심 비평입니다.  
YIE 전체 지식 베이스는 디자인 1,043개 + 헬스/카페인 331개로, 총 1,374개 청크를 포함합니다.
- **Knowledge Graph:** Neo4j 기반 디자인 논문 청크, 허브 태그, SIMILAR_TO 의미 네트워크 구축.
...
> 
> > 📦 [v1 · Mood-DNA](https://github.com/hoilycat/Mood-DNA) · [v2 · Mood-DNA-V2](https://github.com/hoilycat/Mood-DNA-V2) · v3 · 현재
...
- [x] YIE GraphRAG 엔진 구축 (Neo4j, 전체 1,374 chunks / 디자인 1,043 chunks)
